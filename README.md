...
3. `runTasksByPriority()`: The actaul function of running the input task list in an order of task priorities. Higher priorities are having lagerer numerical value.
